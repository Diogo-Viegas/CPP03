...
ClapTrap::ClapTrap()
{
    std::cout << GREEN << "ClapTrap " << _name << ": default constructor." << RESET << std::endl;
    _name = "No name";
    _hitPoints = 10;
    _energyPoints = 10;
    _attackDamage = 0;
...
{
    std::cout << GREEN << "ClapTrap: constructor with name " << name << RESET << std::endl;
    _name = name;
    _hitPoints = 10;
    _energyPoints = 10;
    _attackDamage = 0;
...
{
    std::cout << GREEN << "ClapTrap " << _name << ": copy constructed from '" << obj._name << "'." << RESET << std::endl;
    *this = obj;
}
ClapTrap& ClapTrap::operator=(const ClapTrap &obj)
{
    std::cout << GREEN << "ClapTrap " << _name << ": assigned from '" << obj._name << "'." << RESET << std::endl;
    if(this != &obj)
    {
        _name = obj._name;
...
ClapTrap::~ClapTrap()
{
    std::cout << GREEN << "ClapTrap "<< _name << ": destructor called for '" << _name << "'." << RESET << std::endl;
}